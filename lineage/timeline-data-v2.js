...
(function () {
  ...
  var PEOPLE = [
    ...
    { id: 'A11', line: 'A', gen: 11, year: 1660, t: 495.98, kind: 'founder',
      name: 'Pierre Barbeau & Madeleine Babin',
    ...
    { id: 'D9',  line: 'D', gen: 9, year: 1690, t: 436.94, kind: 'founder',
      name: 'Philipp Jacob Heppell & Margretha',
    ...
    { id: 'E9', line: 'E', gen: 9, year: 1812, t: 1293.88, kind: 'person',
      name: 'Joseph Lepage Sr. & Josephte Couture',
    ...
    { id: 'F-NOEL', line: 'E', gen: 9, year: 1830, t: 1562.80, kind: 'founder',
      name: 'Laurent Noël & Marguerite Duquet dit Marquette',
    ...
    { id: 'C-BITSR', line: 'C', gen: 5, year: 1850, t: 2039.16, kind: 'founder',
      name: 'Joseph Bitournay Sr. & Elmire Rougier',
  ...
  var MIGRATIONS = [
    ...
    { id: 'L-picardy',     t: 124, tHold: 10, line: 'C', isLocation: true,
      label: 'Picardy · Saint-Crépin-Ibouvilliers',
      from: [49.42, 1.94], to: null },
    { id: 'L-rouen',       t: 145, tHold: 8, line: 'C', isLocation: true,
      label: 'Rouen · 1660',
      from: [49.44, 1.10], to: null },
    { id: 'L-auvergne',    t: 164, tHold: 10, line: 'B', isLocation: true,
      label: 'Auvergne · Clermont-Ferrand',
      from: [45.78, 3.08], to: null },
    { id: 'L-rhineland',   t: 214, tHold: 10, line: 'D', isLocation: true,
      label: 'Rhineland · Baumholder',
      from: [49.61, 7.34], to: null },
    { id: 'L-saintonge',   t: 246, tHold: 10, line: 'A', isLocation: true,
