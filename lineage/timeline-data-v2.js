...
(function () {
  ...
  var PEOPLE = [
    ...
    { id: 'D2-PAUL', line: 'D', gen: 2, year: 1941, t: 2411.34, kind: 'person',
      name: 'Paul A. Lepel',
      sub: 'U.S. Air Force · Elmendorf AFB, Alaska · computer programmer 23 yrs',
      parents: ['UN-CD'] },
    { id: 'D2-ROGER', line: 'D', gen: 2, year: 1945, t: 2787.86, kind: 'person',
      name: 'Roger Lepel',
      sub: 'Ronald\'s brother',
      parents: ['UN-CD'] },
    { id: 'SP-D2-PAUL', line: 'D', gen: 2, year: 1945, t: 2787.86, kind: 'spouse',
      name: 'Judy Darling',
      sub: 'm. Paul Lepel · retired in Florida',
      spouseOf: 'D2-PAUL' },
    { id: 'UN-PAUL-JUDY', line: 'D', gen: 0, year: 1968, t: 2796.00, kind: 'union',
      name: 'Paul ⚭ Judy',
      sub: 'Lepel · Darling',
      parents: ['D2-PAUL', 'SP-D2-PAUL'] },
    { id: 'GEN1-JP', line: 'TRUNK', gen: 1, year: 1969, t: 2566.82, tLight: 2796.00,
      kind: 'descendant',
      name: 'Jon Paul Lepel',
      sub: 'b. Jan 1969 · Daniel\'s cousin',
      parents: ['UN-PAUL-JUDY'], dimmedUntilLight: true },
    { id: 'GEN1-CH', line: 'TRUNK', gen: 1, year: 1974, t: 2796.00, tLight: 2800.00,
      kind: 'descendant',
  ...
  var MIGRATIONS = [
    ...
    { id: 'L-stlawrence', t: 143, tHold: 18, line: 'TRUNK', isLocation: true,
      label: 'Saint Lawrence · Champlain\'s maps · 1603',
      from: [46.81, -71.21], to: null },
    { id: 'L-picardy',     t: 159, tHold: 22, line: 'C', isLocation: true,
      label: 'Picardy · Saint-Crépin-Ibouvilliers',
      from: [49.42, 1.94], to: null },
    { id: 'L-quebec',      t: 210, tHold: 14, line: 'TRUNK', isLocation: true,
      label: 'Quebec City founded · 1608',
      from: [46.81, -71.21], to: null },
    { id: 'L-rouen',       t: 250, tHold: 14, line: 'C', isLocation: true,
      label: 'Rouen · Charles Bétourné died here · 1660',
      from: [49.44, 1.10], to: null },
    { id: 'L-auvergne',    t: 308, tHold: 22, line: 'B', isLocation: true,
      label: 'Auvergne · Clermont-Ferrand',
      from: [45.78, 3.08], to: null },
    { id: 'L-rhineland',   t: 430, tHold: 22, line: 'D', isLocation: true,
      label: 'Rhineland · Baumholder',
      from: [49.61, 7.34], to: null },
    { id: 'L-saintonge',   t: 494, tHold: 22, line: 'A', isLocation: true,
