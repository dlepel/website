...
/* =====================================================================
   ...
   ===================================================================== */
// Each entry:
//   label  — full headline name
//   short  — medium-width form (60–100px bands)
//   mini   — abbreviated short form (narrow bands, 30–60px)
//   note   — tooltip detail tying the event to the family story
const HISTORY_EVENTS = [
  // PRE-COLONIAL
  { start:1608,           label:'Quebec City founded',                            short:'Quebec founded', mini:'Quebec',        tier:2,
    note:'Champlain plants the colony Adrien Bétourné, Mathieu Mangot, and Jean Heppell will one day reach.' },
  { start:1663, end:1673, label:'Filles du Roi program',                          short:'Filles du Roi',  mini:'Filles du Roi', tier:2,
    note:'770 women shipped to New France to balance the sex ratio — wives for the soldiers who would father the Bétourné and Mongeau lines.' },
  // CARIGNAN-SALIÈRES ERA
  { start:1665, end:1668, label:'Carignan-Salières Regiment campaigns',           short:'Carignan-Salières', mini:'Carignan',  tier:1, t:240,
    note:'Adrien Bétourné dit Laviolette crosses with this regiment in 1665 — the founding crossing of the Bétourné line.' },
  { start:1666,           label:'Mohawk villages burned',                         short:'Mohawk campaign',  mini:'Mohawks',    tier:2, t:330,
    note:'The regiment marches into the Mohawk Valley and razes four villages — the violence that purchases peace for the colony.' },
  { start:1667,           label:'Iroquois Confederacy sues for peace',            short:'Iroquois peace',   mini:'Peace',      tier:2,
    note:'Peace settles the Saint Lawrence valley just in time for the regiment\u2019s soldiers to take up land grants and start families.' },
  { start:1685,           label:'Edict of Fontainebleau (revokes Edict of Nantes)', short:'Edict revoked', mini:'Edict',      tier:2,
    note:'Louis XIV outlaws Protestantism in France — Huguenot families like the Heppells in the Rhineland feel the pressure of confessional war.' },
  // EARLY 1700s
  { start:1707,           label:'War of Spanish Succession',                       short:'Spanish Succ.',   mini:'War',        tier:2,
    note:'Johann Nickolaus Heppell is baptized in Baumholder, Prussia, in the middle of this European war.' },
  { start:1709, end:1710, label:'Great Palatine migration to colonial New York', short:'Palatine wave',   mini:'Palatines',  tier:2,
    note:'Thousands of Rhineland Germans flee to Queen Anne\u2019s New York colony — the wave the Heppells will join a generation later.' },
  // COLONIAL WARS
  { start:1754, end:1763, label:'French & Indian War / Seven Years\u2019 War',   short:'Fr. & Ind. War',  mini:'F&I War',    tier:2,
    note:'A world war fought in our ancestors\u2019 forests; ends with British conquest of New France.' },
  { start:1763,           label:'Treaty of Paris ends French rule in N. America',short:'British conquest',mini:'Conquest',   tier:1, t:491,
    note:'France cedes Canada to Britain. Our Quebec ancestors wake up British subjects on Catholic French soil.' },
  { start:1774,           label:'Quebec Act preserves French law & Catholic rights', short:'Quebec Act',  mini:'Quebec Act', tier:2,
    note:'London lets the conquered keep their language, law, and faith — the reason the Bétournés and Mongeaus stay French for another century.' },
  // REVOLUTIONARY
  { start:1775, end:1783, label:'American Revolution',                            short:'Am. Revolution', mini:'Am. Rev.',   tier:1, t:665,
    note:'Salem, New York is burned by Burgoyne\u2019s troops in 1777; the Heppells reportedly flee north to Quebec during the war.' },
  { start:1776,           label:'Declaration of Independence',                    short:'Declaration',    mini:'1776',       tier:2,
    note:'The thirteen colonies break with Britain — and with the British Empire that has just absorbed our Quebec relatives.' },
  { start:1783,           label:'Loyalist migrations to British Canada',          short:'Loyalist wave',  mini:'Loyalists',  tier:2,
    note:'Roughly 50,000 Loyalists move north; the Heppells\u2019 path from Salem NY to Quebec runs with this current.' },
  { start:1789, end:1799, label:'French Revolution',                              short:'Fr. Revolution', mini:'Fr. Rev.',   tier:2,
    note:'The country our French ancestors left a century earlier overturns its king.' },
  // 1800s
  { start:1812, end:1815, label:'War of 1812',                                    short:'War of 1812',    mini:'1812',       tier:2,
    note:'A second Anglo-American war on the border the family has already crossed twice.' },
  { start:1837, end:1838, label:'Lower Canada Rebellion',                         short:'Lower Canada Reb.', mini:'1837',    tier:2,
    note:'The Patriote uprising sweeps through the Richelieu valley, blocks from where our Bétournés and Barbeaus farm.' },
  { start:1840, end:1930, label:'French-Canadian Great Migration to New England',short:'Great Migration', mini:'FCM',       tier:1, t:835,
    note:'Nearly a million Québécois cross south for mill work — the current that carries the Bétournés, Mongeaus, and Barbeaus to Massachusetts.' },
  { start:1861, end:1865, label:'American Civil War',                             short:'Civil War',      mini:'Civil War',  tier:2,
    note:'The war that drove the New England textile boom French-Canadians would soon arrive to staff.' },
  { start:1867,           label:'Canadian Confederation',                         short:'Confederation',  mini:'1867',       tier:2,
    note:'Quebec becomes a province of a new Canadian nation — the same year Joseph Wilfred Barbeau is conceived.' },
  { start:1873, end:1879, label:'The Long Depression',                            short:'Long Depression',mini:'Depression', tier:2,
    note:'A worldwide slump that pushes more Québécois families to look south for work.' },
  // EARLY 1900s
  { start:1907,           label:'Sprague Electric founded in North Adams',        short:'Sprague est.',   mini:'Sprague',    tier:2,
    note:'The mill that will one day employ Ronald Lepel and anchor the family in North Adams.' },
  { start:1914, end:1918, label:'World War I',                                    short:'World War I',    mini:'WWI',        tier:1, t:1335,
    note:'Eugène Bétourney registers for the draft in Athol, Massachusetts.' },
  { start:1918, end:1919, label:'Spanish flu pandemic',                           short:'Spanish flu',    mini:'Flu',        tier:2,
    note:'The pandemic sweeps the mill towns the family has just settled in.' },
  { start:1929, end:1939, label:'Great Depression',                               short:'Great Depression', mini:'Depression', tier:2, t:1262,
    note:'The decade frames the 1931 marriage of Ronald Lepel and Lorraine Barbeau — four lines becoming one in lean times.' },
  { start:1939, end:1945, label:'World War II',                                   short:'World War II',   mini:'WWII',       tier:1, t:1380,
    note:'Ronald Lepel serves; the North Adams mills run at full tilt for the war effort.' },
  // LATE 20TH C.
  { start:1947, end:1965, label:'Berkshires industrial decline',                  short:'Mills decline',  mini:'Mills',      tier:2,
    note:'Textile and electric plants begin closing; the economic ground the family stood on starts to shift.' },
  { start:1965, end:1975, label:'Vietnam War',                                    short:'Vietnam',        mini:'Vietnam',    tier:2,
    note:'The era of Daniel\u2019s birth (1965) and Renee\u2019s (1968).' },
  { start:1980,           label:'1st Quebec Sovereignty Referendum',              short:'Quebec Ref. \u201880', mini:'Ref. \u201880', tier:2,
    note:'Quebec votes on independence — 40% Yes. The Canadian relatives the family left behind are still asking what country they belong to.' },
  { start:1985,           label:'Sprague Electric closes North Adams',            short:'Sprague closes', mini:'Sprague',    tier:2,
    note:'The mill that made the family\u2019s middle-class life shuts its doors.' },
  { start:1995,           label:'2nd Quebec Sovereignty Referendum',              short:'Quebec Ref. \u201895', mini:'Ref. \u201895', tier:2,
    note:'A second vote, 49.4% Yes — the closest Quebec has come to leaving Canada.' },
  { start:1999,           label:'MASS MoCA opens in North Adams',                 short:'MASS MoCA',      mini:'MoCA',       tier:2,
    note:'The old Sprague Electric campus reopens as a contemporary-art museum — the mill town finds a second life.' },
  // 21ST C.
  { start:2001,           label:'September 11 attacks',                           short:'September 11',   mini:'9/11',       tier:2,
    note:'The defining American moment of the generation that grew up in Massachusetts.' },
  { start:2008, end:2009, label:'Great Recession',                                short:'Great Recession',mini:'Recession',  tier:2,
    note:'A second economic shock to the post-industrial Berkshires.' },
  { start:2020, end:2021, label:'COVID-19 pandemic',                              short:'COVID-19',       mini:'COVID',      tier:2,
    note:'A second pandemic in a century reaches the same family that lived through 1918.' },
  { start:2025.96,        label:'Bill C-3 takes effect (15 Dec 2025)',            short:'Bill C-3',       mini:'Bill C-3',   tier:1, t:1487,
    note:'Canada restores citizenship by descent — giving Daniel and Renee Canadian citizenship through their great-great-grandfather Joseph Wilfred Barbeau.' },
];
